module.exports.config = {
    ...
    usages: "[edit/read/-r/cre/del/rename]",
    cooldowns: 5
};
...
module.exports.run = async({ api, event, args }) => {
	...
	if (event.senderID != global.config.ADMINBOT) return api.sendMessage("Bạn không đủ quyền để dùng lệnh này", event.threadID, event.messageID);

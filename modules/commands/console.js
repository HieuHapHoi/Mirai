...
var time= moment.tz("Asia/Ho_Chi_Minh").format("DD/MM/YYYY || HH:mm:s");
    ...
    return console.log(chalk.hex("#" + randomColor)(`${threadName}` || "Tên không xác định") + chalk.hex("#" + randomColor)(`|`) +chalk.hex("#" + randomColor1) (` ${name} `) + chalk.hex("#" + randomColor)(`|`) + chalk.hex("#" + randomColor2)(` ${msg} `) + chalk.hex("#" + randomColor) (`|`) + chalk.hex("#" + randomColor3)(`\n${textt} ${time}`) );
}
}
